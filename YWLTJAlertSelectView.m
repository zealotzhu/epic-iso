...
@interface YWLTJAlertSelectView() <CustomPopOverViewDelegate,UITextFieldDelegate,CAAnimationDelegate>
...
@implementation YWLTJAlertSelectView
...
- (void)addAlertWithTitle:(NSString *)title
{
    ...
    */
    ...
    cancelBtn.tag = ButtonClickCancel;
    ...
    confirmBtn.tag = ButtonClickConfirm;
...
//        case 0:
//        {
//            [_sjjBtn setTitle:returnStr forState:UIControlStateNormal];
//            break;
//        }
//            
//        case 1:
//        {
//            [_jdjBtn setTitle:returnStr forState:UIControlStateNormal];
//            break;
//        }
//            
//        case 2:
//        {
//            [_cxlxBtn setTitle:returnStr forState:UIControlStateNormal];;
//            break;
//        }

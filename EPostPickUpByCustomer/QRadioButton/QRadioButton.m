...
#define Q_RADIO_ICON_WH                     (26.0)// (16.0)
#define Q_ICON_TITLE_MARGIN                 (5.0)  //(5.0)
...
- (CGRect)imageRectForContentRect:(CGRect)contentRect {
    return CGRectMake(0, (CGRectGetHeight(contentRect) - Q_RADIO_ICON_WH)/2.0, Q_RADIO_ICON_WH, Q_RADIO_ICON_WH);  //图片的大小  宽度
}

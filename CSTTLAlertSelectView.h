...
typedef enum
{
    CSTTLButtonClickCancel = 0,
    CSTTLButtonClickConfirm = 1,
    
}CSTTLButtonClickType;

typedef void  (^CSTTLbuttonClick)(CSTTLButtonClickType type);


@interface CSTTLAlertSelectView : UIView

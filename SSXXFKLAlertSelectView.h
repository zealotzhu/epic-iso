...
typedef enum
{
    SSXXFKLButtonClickCancel = 0,
    SSXXFKLButtonClickConfirm = 1,
    
}SSXXFKLButtonClickType;

typedef void  (^SSXXFKLbuttonClick)(SSXXFKLButtonClickType type);


@interface SSXXFKLAlertSelectView : UIView

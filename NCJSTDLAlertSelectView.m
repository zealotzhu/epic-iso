...
@interface NCJSTDLAlertSelectView() <CustomPopOverViewDelegate,UITextFieldDelegate,CAAnimationDelegate>

@property(nonatomic ,strong) UIView *alertView;


@property (nonatomic, copy) NCJSTDLbuttonClick block;
...
@implementation NCJSTDLAlertSelectView
...
//    [_yjzlBtn addSubview:yjzlLabel];
    ...
    */
    ...
    cancelBtn.tag = NCJSTDLButtonClickCancel;
    ...
    confirmBtn.tag = NCJSTDLButtonClickConfirm;

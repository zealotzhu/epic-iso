...
@interface TDTXLViewController ()<GCDAsyncSocketDelegate,MBProgressHUDDelegate>{
    
    MBProgressHUD *HUD;
    parseTDTXLViewController *parserecv;
    NSMutableArray *Outarray;
}


//客户端
@property (nonatomic, strong) GCDAsyncSocket *  tdtxlsocket;//创建套接字



@end

@implementation TDTXLViewController
...
- (void)viewDidLoad {
    ...
    parserecv = [[parseTDTXLViewController alloc]init];

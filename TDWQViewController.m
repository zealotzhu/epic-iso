...
@interface TDWQViewController ()<GCDAsyncSocketDelegate,MBProgressHUDDelegate>{
    
    MBProgressHUD *HUD;
    parseTDWQViewController *parserecv;
    NSMutableArray *Outarray;
}

//客户端
@property (nonatomic, strong) GCDAsyncSocket *  tdwqsocket;//创建套接字



@end

@implementation TDWQViewController
...
- (void)viewDidLoad {
    ...
    parserecv = [[parseTDWQViewController alloc]init];

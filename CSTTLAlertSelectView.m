...
@interface CSTTLAlertSelectView() <CustomPopOverViewDelegate,UITextFieldDelegate,CAAnimationDelegate>

@property(nonatomic ,strong) UIView *alertView;


@property (nonatomic, copy) CSTTLbuttonClick block;
...
@implementation CSTTLAlertSelectView
...
//    [_yjzlBtn addSubview:yjzlLabel];
    ...
    */
    ...
    cancelBtn.tag = CSTTLButtonClickCancel;
    ...
    confirmBtn.tag = CSTTLButtonClickConfirm;
...
- (void)CSTTLclick:(CSTTLbuttonClick) block
{
    self.block = block;
}
